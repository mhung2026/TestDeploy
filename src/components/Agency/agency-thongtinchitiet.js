...
export default function AgencyThongTinChiTiet() {
    ...
    return (
        <div>
            ...
            <p>Real Estate Name: {editing ? <input type="text" name="realestateName" value={editedRealEstate.realestateName} onChange={handleInputChange} /> : realEstate.realestateName}</p>
            <p>Address: {editing ? <input type="text" name="address" value={editedRealEstate.address} onChange={handleInputChange} /> : realEstate.address}</p>
            <p>Room Number: {editing ? <input type="text" name="roomNumber" value={editedRealEstate.roomNumber} onChange={handleInputChange} /> : realEstate.roomNumber}</p>
            <p>Length: {editing ? <input type="text" name="length" value={editedRealEstate.length} onChange={handleInputChange} /> : realEstate.length}</p>
            <p>Width: {editing ? <input type="text" name="width" value={editedRealEstate.width} onChange={handleInputChange} /> : realEstate.width}</p>
            <p>Perimeter: {editing ? <input type="text" name="perimeter" value={editedRealEstate.perimeter} onChange={handleInputChange} /> : realEstate.perimeter}</p>
            <p>Area: {editing ? <input type="text" name="area" value={editedRealEstate.area} onChange={handleInputChange} /> : realEstate.area}</p>
            <p>Legal Status: {editing ? <input type="text" name="legalStatus" value={editedRealEstate.legalStatus} onChange={handleInputChange} /> : realEstate.legalStatus}</p>
            <p>Price: {editing ? <input type="text" name="price" value={editedRealEstate.price} onChange={handleInputChange} /> : realEstate.price}</p>
            <p>Direct ID: {editing ? <input type="text" name="directId" value={editedRealEstate.directId} onChange={handleInputChange} /> : realEstate.directId}</p>
            <p>Discount: {editing ? <input type="text" name="discount" value={editedRealEstate.discount} onChange={handleInputChange} /> : realEstate.discount}</p>
            <p>Description: {editing ? <input type="text" name="description" value={editedRealEstate.discription} onChange={handleInputChange} /> : realEstate.discription}</p>
